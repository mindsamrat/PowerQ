...
export const questions: Question[] = [
  ...
  },
  {
    ...
    probes: ["control", "visibility", "timeHorizon"],
    primaryAxis: "control",
    framework: {
    ...
    options: [
      { id: "a", text: "Take over the next decision openly and let the results speak.", scores: { control: 15, visibility: 10, powerSource: 5 } },
      { id: "b", text: "Make yourself quietly indispensable until they can't route around you.", scores: { control: 10, visibility: -10, timeHorizon: 15 } },
      { id: "c", text: "Leave. A room that can't see you isn't worth fixing.", scores: { timeHorizon: -15, powerSource: 5 } },
      { id: "d", text: "Win them over one at a time until the room reorganises around you.", scores: { control: 5, visibility: 5, timeHorizon: 10, powerSource: -15 } },
    ],
  },
  {
    id: "q06c",
    ...
    probes: ["control", "visibility", "powerSource"],
    primaryAxis: "control",
    framework: {
    ...
    options: [
      { id: "a", text: "Correct them right there, calmly, so everyone sees the line.", scores: { control: 15, visibility: 15, powerSource: 10 } },
      { id: "b", text: "Say nothing now. Handle it privately, where it actually costs them.", scores: { control: 10, visibility: -15, timeHorizon: 15, powerSource: 10 } },
      { id: "c", text: "Laugh it off — and never give them access again.", scores: { control: 5, timeHorizon: 10, powerSource: -5 } },
      { id: "d", text: "Match them. If they want a scene, they get a scene.", scores: { control: 10, visibility: 10, timeHorizon: -15, powerSource: 15 } },
    ],
  },
  {
    id: "q06d",
    ...
    probes: ["control", "timeHorizon", "visibility"],
    primaryAxis: "control",
    framework: {
    ...
    options: [
      { id: "a", text: "Go over the decision-maker's head and make the case yourself.", scores: { control: 15, visibility: 10, timeHorizon: -10 } },
      { id: "b", text: "Study exactly why they're winning and copy the mechanism, not the person.", scores: { control: 10, timeHorizon: 15, powerSource: -5 } },
      { id: "c", text: "Build something they can't compete with and let the gap become obvious.", scores: { control: 10, visibility: 5, timeHorizon: 20 } },
      { id: "d", text: "Get close to them. Their access becomes your access.", scores: { control: 5, visibility: -10, timeHorizon: 10, powerSource: -10 } },
    ],
  },
  {
    id: "q07",
